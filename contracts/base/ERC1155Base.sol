...
contract ERC1155Base is ERC1155, ContractMetadata, Ownable, Royalty, Multicall, BatchMintMetadata {
    ...
    /*//////////////////////////////////////////////////////////////
                        mintable logics
    //////////////////////////////////////////////////////////////*/
    // @dev     _state is boolean true/false
        // can change the current state of public mint 
        function FlipMintable(bool _state) public  {
    ...
    function mintTo(
        ...
        require(mintable==true||_canMint(), "Not authorized to mint.");
